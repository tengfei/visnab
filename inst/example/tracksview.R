...
library(qtpaint)
library(visnab)
gr.ref <- getIdeogram("hg18",cyto=FALSE)
gr <- getIdeogram("hg18",cyto=TRUE)
save(gr.ref,gr,file="~/Datas/rdas/gr.rda")
load(file="~/Datas/rdas/gr.rda")
obj.ref <- SeqView(gr.ref)
## data(kgsub)
...
## save(tks,obj.ref,cdsi,obj.ali,gr,file="~/Datas/rdas/tks.rda")
tks$show()
