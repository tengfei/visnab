##----------------------------------------------------------------------------##
##             For class "GenomeRefView"
##----------------------------------------------------------------------------##

setClass("GenomeRefView",contains="GraphicPars",
...
GenomeRefView <- function(obj,...){
  pars <- GraphicPars(...)@pars
  new("GenomeRefView",track=obj, pars=pars, strand="+")
}
...
setMethod("visplot","GenomeRefView",function(obj,seqname,start=NULL,
